...
#SBATCH --job-name=AI-HERO_energy_baseline_evaluation_conda
...
forecast_path=${group_workspace}/AI-HERO_Energy/forecasts.csv
...
python3 -u ${group_workspace}/AI-HERO_Energy/evaluation.py --save_dir "$PWD" --data_dir ${data_dir} --forecast_path ${forecast_path}
